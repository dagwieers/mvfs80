/* * (C) Copyright IBM Corporation 2002, 2012. */
/*
...
*/
#if !defined(_VOB_KERNEL_H_)
#define _VOB_KERNEL_H_

#include <tbs_acl_kernel.h>


/* Verify that the ACL specific bits are what we think they should be. */
#if (0x0780ffff & ~TBS_ACL_PERMS_SPECIFIC_MASK) != 0
#error tbs_acl.h is not playing fair
#endif

#define RIGHTS_OBJECT_LOCK              0x04000000
#define RIGHTS_OBJECT_MOD_HLINK         0x02000000
#define RIGHTS_OBJECT_MOD_ATTR          0x01000000
#define RIGHTS_OBJECT_CHMASTER          0x00800000
#define RIGHTS_OBJECT_MOD_PROPS         0x00008000
#define RIGHTS_OBJECT_READ_INFO         0x00004000
#define RIGHTS_OBJECT_READ_NAME         0x00002000

#define ELEMENT_RIGHTS_READ_INFO        RIGHTS_OBJECT_READ_INFO
#define ELEMENT_RIGHTS_MOD_PROPS        RIGHTS_OBJECT_MOD_PROPS
#define ELEMENT_RIGHTS_CHMASTER         RIGHTS_OBJECT_CHMASTER
#define ELEMENT_RIGHTS_MOD_CHECKOUT     0x00000001
#define ELEMENT_RIGHTS_MOD_TRIG         0x00000002
#define ELEMENT_RIGHTS_MOD_BRANCH       0x00000004
#define ELEMENT_RIGHTS_RMVER            0x00000008
#define ELEMENT_RIGHTS_MOD_LABEL        0x00000010
#define ELEMENT_RIGHTS_MOD_TASK         0x00000020
#define ELEMENT_RIGHTS_WRITE_DIR        0x00000040
#define ELEMENT_RIGHTS_LOOKUP_DIR       0x00000080
#define ELEMENT_RIGHTS_READ_ACL         TBS_ACL_PERM_READ_ACL
#define ELEMENT_RIGHTS_WRITE_ACL        TBS_ACL_PERM_WRITE_ACL
#define ELEMENT_RIGHTS_DELETE           TBS_ACL_PERM_DELETE
#define ELEMENT_RIGHTS_LOCK             RIGHTS_OBJECT_LOCK
#define ELEMENT_RIGHTS_MOD_ATTR         RIGHTS_OBJECT_MOD_ATTR
#define ELEMENT_RIGHTS_MOD_HLINK        RIGHTS_OBJECT_MOD_HLINK
...
#define VOB_NUM_MTYPES_FL8 (VOB_MTYPE_ROLEMAP + 1)
...
/****************************************************************************
 * VOB_MTYPE_IS_ACL_MTYPE
 * Decide whether a meta-type is an ACL mtype.
 * IN   mtype       meta-type
 * RESULT:      TRUE if yes; FALSE if no
 */

#define VOB_MTYPE_IS_ACL_MTYPE(mtype)           \
    ((mtype) == VOB_MTYPE_POLICY ||             \
     (mtype) == VOB_MTYPE_ROLEMAP               \
    )

/****************************************************************************
 * VOB_MTYPE_CASE_ACL_MTYPE
 * Switch statement case for ACL objects. 
 */

#define VOB_MTYPE_CASE_ACL_MTYPE                \
     case VOB_MTYPE_POLICY:                     \
     case VOB_MTYPE_ROLEMAP
 ...
 * FL6 or lower, while ACLs only show up in FL8 or higher */
...
/****************************************************************************
 * VOB_MTYPE_CAN_BE_IN_POLICY
 * Decide whether a meta-type can be in a policy.
 * IN	mtype		meta-type
 * RESULT:		TRUE if yes; FALSE if no
 */

#define VOB_MTYPE_CAN_BE_IN_POLICY(mtype)       \
    ((mtype) == VOB_MTYPE_FILE_ELEM ||          \
     (mtype) == VOB_MTYPE_POLICY ||             \
     (mtype) == VOB_MTYPE_ROLEMAP ||            \
     (mtype) == VOB_MTYPE_VOB                   \
    )
#define VOB_MTYPE_IN_POLICY_COUNT 4

/****************************************************************************
 * VOB_MTYPE_CASE_IN_POLICY
 * Switch statement case labels for object mtypes that can be in policies. See
 * VOB_MTYPE_OK_IN_POLICY() above.  Final ":" comes from the calling site.
 */

#define VOB_MTYPE_CASE_IN_POLICY                \
     case VOB_MTYPE_FILE_ELEM:                  \
     case VOB_MTYPE_POLICY:                     \
     case VOB_MTYPE_ROLEMAP:                    \
     case VOB_MTYPE_VOB
...
/* On FL7, mtypes are up to VOB_MTYPE_UCM_LEGACY_OBJ */

#define VOB_NUM_MTYPES_BY_FL(flevel)			\
      (((flevel) <= VOB_FEATURE_LEVEL_6) ? VOB_NUM_MTYPES_FL6 : \
        (((flevel) <= VOB_FEATURE_LEVEL_7) ? VOB_NUM_MTYPES_FL7 : \
          VOB_NUM_MTYPES_FL8))

#endif /* _VOB_KERNEL_H_ */
/* $Id: dbe676be.453911e2.969a.00:01:83:9c:f6:11 $ */
