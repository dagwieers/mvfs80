...
4c) We now use a java program to determine the current
...
4d) If the previous step fails, or if you want to use nonstandard values, 
    ...
    RATL_EXTRAFLAGS := <appropriate value>
        ...
        -DRATL_VENDOR_VER=<Version times 100 plus the update number>
            For example RHEL5 Update 5 -DRATL_VENDOR_VER=505
            For SLES10 SP2  -DRATL_VENDOR_VER=1002
            For RH MRG 1.3  -DRATL_VENDOR_VER=500
            For RH MRG 2.0  -DRATL_VENDOR_VER=600
            For Ubuntu 12.04  -DRATL_VENDOR_VER=1204
        -DRATL_EXTRA_VER=0
        -DRATL_COMPAT32
...
4e) Build and install the mvfs module:
