...
{
    struct task_struct *task = (struct task_struct *) p;
    /* In early 2.6, Linux moved the TASK_ZOMBIE and TASK_DEAD
...
*/
#if (defined(ATRIA_LP64) || defined(ATRIA_LLP64)) && defined(noinline)
...
#endif /* MVFS_MDKI_H_ */
/* $Id: 8b38d5ab.f76811e1.86e2.00:01:84:c3:8a:52 $ */
