...
#endif
#ifndef MVFS_SAVE_INTR_T
#define MVFS_SAVE_INTR_T     int
#endif
...
#ifndef MDKI_ATOMIC_SET_UINT32
#define MDKI_ATOMIC_SET_UINT32(addr, val)   (*(addr) = (val))
#endif
...
#ifndef MDKI_ATOMIC_PTR_READ
#define MDKI_ATOMIC_PTR_READ(addr)          (*(addr))
#endif

#ifndef MDKI_ATOMIC_PTR_SET
#define MDKI_ATOMIC_PTR_SET(addr, val)      (*(addr) = (val))
#endif
...
#endif /* MVFS_SYSTM_H_ */
/* $Id: a9f6851b.b90e4ece.9ff3.b5:57:9a:e6:9c:e7 $ */
